...
def start_group_slaves(master_group_id):
    ...
    :param master_group_id: The master group ID. The ID
    belongs to the master whose slaves need to be started.
    """
...
def stop_group_slaves(master_group_id,  clear_ref):
    ...
    for slave_group_id in master_group.slave_group_ids:
        ...
        if slave_group is None:
            raise _errors.GroupError \
            (GROUP_REPLICATION_GROUP_NOT_FOUND_ERROR % (slave_group_id, ))
